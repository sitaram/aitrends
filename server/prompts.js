...
export const prompts = {
  ...
  News:
    'Compile the latest news articles and reports related to ${topic} in the last two weeks as of today. Provide insights on' +
  ...
  Research:
    'Based on your last update in 2023, provide an overview of the most significant research papers with findings or theoretical advancements in ${topic} that have been documented in arXiv or Google Scholar publications. Please limit your response to information that reflects the consensus or notable perspectives within the academic community up to that time. If this topic has not been clearly covered in your training data from arXiv or Google Scholar, please indicate that the information is not available. Focus on identifying studies that have significantly advanced the understanding or application of the topic. Recognize the methodology, findings, and implications of each paper, grouping them into thematic categories to facilitate easy navigation and comprehension. Keep it tight and concise, with one section per a group or category of papers, about 3 to 5 sections total, with a <h3> section title using ###. In each section there is a short bulleted list in description list format, with one bullet point per paper, with description list header as the paper title in bold, without quotes, then year and authors in parentheses, then a colon. (* *Paper title* (publication year, authors): Paper description). In that same bullet point, offer a brief summary that encapsulates its core contribution to the field and its relevance to ongoing research or practical applications. Aim to cater to both newcomers and seasoned experts in the field by providing insights that are both educational and deeply informative.',
...
export const webSearchPrompt =
  ...
  ' NOTE that these snippets are the actual snippets from a web search right now, so your information is NOT hypothetical.' +
  ' Avoid mentioning your lack of information or inability to browse the internet or lack of data since your model refresh.' +
  ' Be confident that you are providing accurate information based on the Search Result Snippets. The Search Result Snippets:';
